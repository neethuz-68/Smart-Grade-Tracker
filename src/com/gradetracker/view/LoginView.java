...
public class LoginView extends JFrame {
    ...
    private JButton signInButton; // ✅ Added
    ...
    public LoginView() {
        ...
        JPanel panel = new JPanel(new GridBagLayout()) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(new Color(0, 0, 0, 60)); // semi-transparent black shadow
        ...
        // ✅ --- Sign In Button (added without changing anything) ---
